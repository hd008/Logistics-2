...
<div id="context">
    <div id="menu">
        <div id="cen">
            <dd><a href="addOrder.jsp" target="ifr">订单增加</a></dd>
            <dd><a href="deleteOrder.jsp" target="ifr">订单删除</a></dd>
            <dd><a href="updateOrder.jsp" target="ifr">订单更新</a></dd>
            <dd><a href="queryOrder.jsp" target="ifr">订单查询</a></dd>
        </div>

    </div>
    <div id="area"><iframe src="" name="ifr"></iframe></div>
</div>
</body>
</html>
